...
x_train = np.concatenate((L2_normal[:-1000], L2_attack[:-5000]), axis=0)
y_train = np.ones((len(x_train), 1))
y_train[:(len(L2_normal[:-1000]))]  = 0
...
weightDir = os.path.join(tempStore, 'weights_c2.h5')
